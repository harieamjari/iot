...
void app_main(void)
{
    ...
    bool do_calibration1_chan6 = example_adc_calibration_init(ADC_UNIT_1, ADC_CHANNEL_6, EXAMPLE_ADC_ATTEN, &adc1_cali_chan0_handle);
    bool do_calibration1_chan7 = example_adc_calibration_init(ADC_UNIT_1, ADC_CHANNEL_7, EXAMPLE_ADC_ATTEN, &adc1_cali_chan1_handle);
    bool do_calibration1_chan4 = example_adc_calibration_init(ADC_UNIT_1, ADC_CHANNEL_4, EXAMPLE_ADC_ATTEN, &adc1_cali_chan1_handle);
    ...
    if (do_calibration1_chan6) {
        example_adc_calibration_deinit(adc1_cali_chan6_handle);
    }
    if (do_calibration1_chan7) {
        example_adc_calibration_deinit(adc1_cali_chan7_handle);
    }
